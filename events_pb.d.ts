...
export class SubscribeToEventReq extends jspb.Message {
  getEventid(): string;
  setEventid(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SubscribeToEventReq.AsObject;
  static toObject(includeInstance: boolean, msg: SubscribeToEventReq): SubscribeToEventReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SubscribeToEventReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SubscribeToEventReq;
  static deserializeBinaryFromReader(message: SubscribeToEventReq, reader: jspb.BinaryReader): SubscribeToEventReq;
}

export namespace SubscribeToEventReq {
  export type AsObject = {
    eventid: string,
  }
}

export class UnsubscribeToEventReq extends jspb.Message {
  getEventid(): string;
  setEventid(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UnsubscribeToEventReq.AsObject;
  static toObject(includeInstance: boolean, msg: UnsubscribeToEventReq): UnsubscribeToEventReq.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: UnsubscribeToEventReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UnsubscribeToEventReq;
  static deserializeBinaryFromReader(message: UnsubscribeToEventReq, reader: jspb.BinaryReader): UnsubscribeToEventReq;
}

export namespace UnsubscribeToEventReq {
  export type AsObject = {
    eventid: string,
  }
}
